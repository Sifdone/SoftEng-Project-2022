...
### Use case #3 - See History of repairs
 ...
 Βασική Ροη  
    ...
    5.Το σύστημα ανατρέχει στην βάση δεδομένων και ανακτά τα δεδομένα του επιλεγμένου service
    6.Το σύστημα εμφανίζει τις πληροφορίες του επιλεγμένου service από το χρήστη και εμφανίζει την επιλογή "Download Invoice"  
    7.Ο χρηστης επιλεγει "Download Invoice"  
    8.Το σύστημα ανακτά από τη βάση δεδομένων το service invoice
    9.Το σύστημα εμφανίζει στην οθόνη τις διαθέσιμες επιλογές αποθήκευσης στη συσκευή του χρήστη  
    10.Ο χρήστης επιλέγει να αποθηκευτεί στον αποθηκευτικό χώρο της συσκευής  
    11.Το σύστημα επανέρχεται στην οθόνη repair history 
...
- Εναλλακτική Ροή 1 - Επιλογή διαφορετικού μήνα
    ...
    1.Μετα το 5ο βήμα της Βασικής ροής ο χρήστης επιλέγει διαφορετικό μήνα
...
- Εναλλακτική Ροή 2 - Μη επικύρωση - Επιλογή διαφορετικής Ημερομηνίας
   1.Στο 8 τις Βασικής Ροής ο χρήστης δεν επικυρώνει "Confirm" αλλά επιλέγει "Select another date"
