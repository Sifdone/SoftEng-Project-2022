...
* Βασική Ροη
    Το Ι.Χ του χρήστη δεν βρίσκεται σε κατάσταση επισκευής 
     ...
     3.Το σύστημα εμφανίζει την τελευταία επισκευή και δίνει στο χρήστη την επιλογή "Schedule Now"
     4.Ο χρήστης επιλέγει "Schedule Now"
     5.Το σύστημα ανατρέχει στη βάση δεδομένων διαθέσιμες ημερομηνίες για το επόμενο ραντεβού και εμφανίζει ένα ημερολόγιο με τις διαθέσιμες ημερομηνίες
     6.Ο χρήστης επιλέγει ημερομηνία από τις διαθέσιμες και επιλεγει "Schedule"
     7.Το σύστημα εμφανίζει το μήνυμα "You are about to schedule a regular car service for your car XXX-NNNN on DATE" και από κάτω δύο επιλογές μία επικύρωσης "Confirm" και μία επιλογής άλλης ημερομηνίας "Select        another date".
     8.Ο χρήστης επιλέγει επικύρωση "Confirm"
     9.Το σύστημα ενημερώνει την διαθεσιμότητα στη βάση δεδομένων για την επιλεγμένη ημερομηνία ραντεβού
     10.Το σύστημα ενημερώνει την εφαρμογή του συνεργείου σχετικά με το νέο ραντεβού και αποστέλλει email ενημέρωσης στον χρήστη.
