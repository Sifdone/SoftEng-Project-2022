...
- Εναλλακτικη Ροη
  ...
  7. # Το συστημα δημιουργει ενα QR code για το οχημα και δινει εντολη εκτυπωσης στην συσκευη εκτυπωσης ετικετων QR
  8. Το συστημα δημιουργει ενα QR code για το οχημα και δινει εντολη εκτυπωσης στην συσκευη εκτυπωσης ετικετων QR
     > > > > > > > Stashed changes
...
- Βασική Ροη
  ...
  3. Ο χρηστης επιλεγει “New Campaign”
  4. Η εφαρμογη εμφανιζει την οθονη επιλογη πελατων
  5. Ο χρηστης επιλεγει πελατες εναν-εναν, η μαζικα με βαση τον τυπο οχηματος και επιλεγει “Next”
  6. Επιλεγει τυπο ειδοποιησης: Ειδοποιηση εφαρμογης, email, viber
  7. Εισαγει το κειμενο της ειδοποιησης και παταει επιλεγει αν θελει να αποσταλούν εκεινη τη στιγμη η καποια αλλη την οποια και επιλεγει
  8. Το συστημα αναλογα τις επιλογες στελνει τις ειδοποιήσεις στους πελατες
     > > > > > > > Stashed changes
