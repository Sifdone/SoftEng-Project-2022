...
class Appointment(object):
    ...
    def __init__(self,date,customerId,operationId,length):
        ...
        def updateAgenda(self):
            Agenda.calendar.append(self.date)
        def getAppointment():
            return Appointment()
...
class Customer(object):
    ...
    def changeName(self,newname):
        self.name = newname
    def addCar(licence_plate,model_name,kms,vid,color):
        car = Vehicle(licence_plate,model_name,kms,vid,color)
        return car
    def getContact(self):
       return("Name= {} , Address= {} , Phone= {}".format(self.name , self.address , self.phone))
...
class Vehicle(object):
    ...
    def getHistory():
        return Vehicle.Operation.getDescription()
    def getCarDetails(self):
        return("Licence plate: {}, Model Name: {}, Kms: {}, Vid: {}, Color: {},".format(self.licence_plate,self.model_name,self.kms,self.vid,self.color))
    def createQR(self):
        data = self.id
        img = qrcode.make(data)
        return(img)
    def getService():
        return Vehicle.Service.info
